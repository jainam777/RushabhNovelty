<div class="webcontainer" id="<?php echo $navCategory[3]; ?>">
    <div class="row">
        <div class="col s12 m12 l12 center">
            <h3><?php echo $navCategoryLive[3]; ?></h3>
            <div class="divider"></div>
            <br>
            <img class="responsive-img" style="width:100%;" src="images/category_images/papers_and_paper_bags.jpg" alt="">
        </div>
        ...
        <?php
            ...
            try{
                ...
                $stmt->execute(['category_name'=>$navCategoryLive[3]]);
                $_SESSION['pro_category']=$navCategoryLive[3];
            }
        ...
        <?php
            try{
                ...
                $stmtSub->execute(['category_name'=>$navCategoryLive[3]]);
                foreach($stmtSub as $rows){ ?>
                    ...
                    <div class="col s12 m12 l12" id="sofa">
                        <div class="section">
                            ...
                            $stmt->execute(['subcategory'=>$rows['subcategory_name'],'category_name'=>$navCategoryLive[3]]);
                                foreach($stmt as $row){ 
                                    echo'
