<!DOCTYPE html>
<nav class="nav-wrapper nav-height webcolor nav-padding">
    <div>
            ...
            <li>
                <?php
                    if(isset($_SESSION['rushabh_novelty_user'])){
                        ...
                        echo'<a href="login.php"><span class="webtextcolor"><b>Login</b></span><i class="material-icons right webtextcolor logo">account_circle</i></a>'; 
                    }
                ?>
            </li>
            <li>
