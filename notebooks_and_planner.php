<div class="webcontainer" id="<?php echo $navCategory[6]; ?>">
    <div class="row">
        <div class="col s12 m12 l12 center">
            <h3><?php echo $navCategoryLive[6]; ?></h3>
            <div class="divider"></div>
            <br>
            <img class="responsive-img" style="width:100%;" src="images/category_images/notebooks_and_planners.jpg" alt="">
        </div>
        ...
        <?php
            ...
            try{
                ...
                $stmt->execute(['category_name'=>$navCategoryLive[6]]);
                $_SESSION['pro_category']=$navCategoryLive[6];
            }
        ...
        <?php
            try{
                ...
                $stmtSub->execute(['category_name'=>$navCategoryLive[6]]);
                foreach($stmtSub as $rows){ ?>
                    ...
                    <div class="col s12 m12 l12" id="sofa">
                        <div class="section">
                            ...
                            <?php
                            $stmt = $con->prepare("SELECT products.product_id, products.product_name, products.stock, product_description, products.product_price, category.category_name, subcategory.subcategory_name, product_photos.pic1 from products, category, subcategory, product_photos WHERE products.category_id = category.catergory_id and products.subcategoty_id = subcategory.subcategory_id and products.product_id = product_photos.product_id and category.category_name =:category_name and subcategory.subcategory_name =:subcategory LIMIT 4");
                            $stmt->execute(['subcategory'=>$rows['subcategory_name'],'category_name'=>$navCategoryLive[6]]);
                                foreach($stmt as $row){ 
                                    echo'
