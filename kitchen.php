<div class="webcontainer" id="<?php echo $navCategory[2]; ?>">
    <div class="row">
        <div class="col s12 m12 l12 center">
            <h3><?php echo $navCategoryLive[2]; ?> Furnitures</h3>
                ...
                foreach($stmtSub as $rows){ ?>
                    ...
                    <div class="col s12 m12 l12" id="sofa">
                        <div class="section">
                            ...
                            <?php
                            $stmt = $con->prepare("SELECT products.product_id, products.product_name, products.stock, products.product_description, products.product_price, products.rating, category.category_name, subcategory.subcategory_name, product_photos.pic1 from products, category, subcategory, product_photos WHERE products.category_id = category.catergory_id and products.subcategoty_id = subcategory.subcategory_id and products.product_id = product_photos.product_id and category.category_name =:category_name and subcategory.subcategory_name =:subcategory LIMIT 4");
                                        ...
                                        <div class="col s12 m4 l3 item">
                                            <div class="card">
                                                ...
                                                if($row['stock']>0){
                                                    ...
                                                    <i class="fa fa-shopping-cart" aria-hidden="true"></i> <span id="add_cart">Add to card</span>
                                                    </a>
        ...
        <!-- <div class="col s12 m12 l12" id="sofa">
            <div class="section">
                        ...
                        <div class="card">
                            <a href="product_details.php">
                                ...
                                <div class="card-content black-text">
                                    ...
                                    <br>
                                    <div class="divider"></div>
                                    <span>Price: <i class="fa fa-inr" aria-hidden="true"></i>30000/-</span>
                                    <br>
                                    <span>Ratings: <i class="fa fa-star-o" aria-hidden="true"></i>
                            ...
                            <div class="card-action">
                                <a href="#"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Add to card</a>
                                <a href="#">Buy Now</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="s12 m12 l12">
                        <a href="all_products.php" class="btn max-btn">MORE</a>
                    </div>
                </div>
            </div>
        </div>  
        <div class="col s12 m12 l12" id="chairs">
            <div class="section">
                <div class="row">
                    <div class="col s12 m12 l12 center">
                        <h4><span>CHAIRS</span></h4>
                        <div class="divider"></div>
                    </div>
                </div>
                <div class="row wrapper">
                ...
                <div class="row">
                    <div class="s12 m12 l12">
                        <a href="#" class="btn max-btn">MORE</a>
                    </div>
                </div>
            </div>
        </div>   -->
