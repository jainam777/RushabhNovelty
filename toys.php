<div class="webcontainer" id="<?php echo $navCategory[4]; ?>">
    <div class="row">
        <div class="col s12 m12 l12 center">
            <h3><?php echo $navCategoryLive[4]; ?></h3>
        ...
        <?php
            ...
            try{
                ...
                $stmt->execute(['category_name'=>$navCategoryLive[4]]);
                $_SESSION['pro_category']=$navCategoryLive[4];
            }
        ...
        <?php
            try{
                ...
                $stmtSub->execute(['category_name'=>$navCategoryLive[4]]);
                foreach($stmtSub as $rows){ ?>
                    ...
                    <div class="col s12 m12 l12" id="sofa">
                        <div class="section">
                            ...
                            $stmt->execute(['subcategory'=>$rows['subcategory_name'],'category_name'=>$navCategoryLive[4]]);
                                foreach($stmt as $row){ 
                                    echo'
