<div class="webcontainer" id="<?php echo $navCategory[0]; ?>">
    <div class="row">
        <div class="col s12 m12 l12 center">
            <h3><?php echo $navCategoryLive[0]; ?></h3>
            <div class="divider"></div>
            <br>
            <img class="responsive-img" style="width:100%;" src="images/category_images/party_essentials.jpg" alt="">
        </div>
        ...
        <?php
            ...
            try{
                ...
                $stmt->execute(['category_name'=>$navCategoryLive[0]]);
                $_SESSION['pro_category']=$navCategoryLive[0];
            }
        ...
        <?php
            try{
                ...
                $stmtSub->execute(['category_name'=>$navCategoryLive[0]]);
                foreach($stmtSub as $rows){ ?>
                    ...
                    <div class="col s12 m12 l12" id="sofa">
                        <div class="section">
                            ...
                            $stmt->execute(['subcategory'=>$rows['subcategory_name'],'category_name'=>$navCategoryLive[0]]);
                                foreach($stmt as $row){ 
                                    echo'
