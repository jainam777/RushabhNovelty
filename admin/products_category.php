          ...
          <div class="box">
            ...
            <div class="col-md-12">
				<nav aria-label="Page navigation">
					<ul class="pagination">
				    <li>
				      <a href="products_category.php?page=<?= $Previous; ?>&category=<?= $_GET['category'] ?>" aria-label="Previous">
				        <span aria-hidden="true">&laquo; Previous</span>
				      </a>
				    </li>
            <!-- <li><a href="products_category.php?page=<?=$page; ?>&category=<?= $_GET['category'] ?>"><?= $page; ?></a></li> -->
            <!-- <li><a href="products_category.php?page=<?=$page+1; ?>&category=<?= $_GET['category'] ?>"><?= $page+1; ?></a></li>
            <li><a href="products_category.php?page=<?=$page+2; ?>"><?= $page+2; ?></a></li>
            <li><a href="products_category.php?page=<?=$page+3; ?>"><?= $page+3; ?></a></li>
            <li><a href="products_category.php?page=<?=$page+4; ?>"><?= $page+4; ?></a></li> -->
				    <li>
				      <a href="products_category.php?page=<?= $Next; ?>&category=<?= $_GET['category'] ?>" aria-label="Next">
