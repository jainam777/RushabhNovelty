            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="subcategory_add.php">
                ...
                <div class="form-group">
                    ...
                    <?php
                      $stmtCat = $conn->prepare("SELECT category_name from category");
                      $stmtCat->execute();
                      
                      foreach($stmtCat as $catname){
                    ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="subcategory_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_catname" class="col-sm-3 control-label">Category Name</label>

                    <div class="col-sm-9">
                      <select class="form-control" id="edit_catname" name="catname">
                      <?php
                        $stmtCat = $conn->prepare("SELECT category_name from category");
                        $stmtCat->execute();
                      ...
                      ?>
                        <option selected='selected' value='<?php echo $catname['category_name'];?>'><?php echo $catname['category_name'];?></option>
                        <?php
                        }
                      ?>
                        </select>
                      <!-- <input type="text" class="form-control" id="edit_catname" name="catname" required> -->
                    </div>
                </div>
            </div>
            <div class="modal-footer">
